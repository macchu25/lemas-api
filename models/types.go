...
// Art QR Models for MongoDB Persistence
type ArtQRPlacement struct {
	X    float64 `json:"x" bson:"x"`
	Y    float64 `json:"y" bson:"y"`
	Size float64 `json:"size" bson:"size"`
}

func (p ArtQRPlacement) IsValid() bool {
...
func DefaultPlacement() ArtQRPlacement {
	return ArtQRPlacement{
		X:    0.25,
		Y:    0.25,
		Size: 0.50,
	}
...
type ArtQRPreset struct {
	...
	Placement           *ArtQRPlacement `json:"placement,omitempty" bson:"placement,omitempty"`
	CreatedAt           time.Time       `json:"created_at" bson:"created_at"`
	UpdatedAt           time.Time       `json:"updated_at" bson:"updated_at"`
}

type ArtQRAsset struct {
	Filename    string    `json:"filename" bson:"_id"`
